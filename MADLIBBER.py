...
def madliber():
    ...
    print("Welcome to Mary and Molly's MADLIBBER Story! I need you to answer some questions to help me make a story. \n")

    # Asking the reader for inputs to develop the stories
    noun1 = input(f'{crayons.magenta ("Enter a noun (person, place, thing, idea): ")}' )
    adjective1 = input(f'{crayons.blue ("Enter an adjective (describes or defines a noun; cute, calm, busy, ugly, stinky): ")}' )
    ...
    noun2 = input(f'{crayons.magenta ("Enter another noun: ")}'  )
    verb2 = input(f'{crayons.green ("Enter another verb: ")}'  )
    noun3 = input(f'{crayons.magenta ("Enter one more noun: ")}'  )
    body_part = input(f'{crayons.cyan ("Enter a body part: ")}'  )
    color = input(f'{crayons.red ("Enter a color: ")}'  )
    color2 = input(f'{crayons.red ("Enter a different color: ")}'  )
    adjective3 = input(f'{crayons.blue ("Enter another adjective:")}'  )
    animal = input(f'{crayons.cyan ("Enter a type of animal: ")}'  )
    phrase = input(f'{crayons.cyan ("Enter a phrase (something you say, like, Hey youuu guys!!): ")}'  )
