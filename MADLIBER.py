...
def madliber():
    ...
    if story_number == 1:
        ...
        story = f"\fIn a {adjective1} land, there were two brave girls who always {verb1} {adverb1}. " \
                ...
                f"Worried about their {body_part} the two girls jumped on their {animal} and yelled out '{phrase}!' as they rode away.THE END!"
    
    else:  
        story = f"\fGrandma Shaunu woke up one morning and remembered she had to move the {adjective1} cows!" \
