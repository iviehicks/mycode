...
def madliber():
    ...
    if story_number == 1:
        story = f"\fOnce upon a time, Mary and Molly woke up in a {adjective1} {noun1}, they decided they wanted to go to a {adjective2} {noun2} that was deep inside the {color} forest.  On the way there, Molly tripped and hurt her {body_part}, so Mary bandadged her up till it was nice and {color2}.  They never made it to the forest, but they had a {adjective3} good time! " \
        ...
        story = f"\fGrandma Shaunu woke up one morning and rembered she had to move the {adjective1} cows!  She got on her {adjective2} {animal} and rode out across the {color} field. The cows weren't listening so she called Mary and Molly and told them "{phrase}".  Mary and Molly came to help but the {noun1}  " \
